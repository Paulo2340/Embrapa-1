...
ggplot(wdata_fo %>% filter(fo_grupo == "Muito Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  ...
  title = "Intensidade percentual dos genotipos classificados como Muito Tolerante na Doença FO") + theme(axis.line.y = element_blank())
x11()
### Tolerante
ggplot(wdata_fo %>% filter(fo_grupo == "Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  ...
  labs(x = "Genótipos",
                                          ...
                                          title = "Intensidade percentual dos genotipos classificados como  Tolerante na Doença FO") + theme(axis.line.y = element_blank())
x11()
...
ggplot(wdata_fo %>% filter(fo_grupo == "Muito Pouco Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  geom_bar(stat = "identity") + coord_polar("x", 0) + theme_bw() + 
  theme(legend.position = "none")  + labs(x = "Genótipos",
                                          y = "Frequência Relativa (%)",
                                          title = "Intensidade percentual dos genotipos classificados como  Muito Pouco Tolerante na Doença FO") + theme(axis.line.y = element_blank())
...
ggplot(wdata_fs %>% filter(fs_grupo == "Muito Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  ...
  labs(x = "Genótipos",
                                          y = "Frequência Relativa (%)",
                                          title = "Intensidade percentual dos genotipos classificados como  Muito Tolerante na Doença FS") + theme(axis.line.y = element_blank())
x11()
### Tolerante
ggplot(wdata_fs %>% filter(fs_grupo == "Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  ...
  labs(x = "Genótipos",
                                          y = "Frequência Relativa (%)",
                                          title = "Intensidade percentual dos genotipos classificados como Tolerante na Doença FS") + theme(axis.line.y = element_blank())
x11()
### Muito Pouco Tolerante 
...
ggplot(wdata_fs %>% filter(fs_grupo == "Muito Pouco Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  ...
  labs(x = "Genótipos",
                                          y = "Frequência Relativa (%)",
                                          title = "Intensidade percentual dos genotipos classificados como  Muito Pouco Tolerante na Doença FS") + theme(axis.line.y = element_blank())
...
ggplot(wdata_fs %>% filter(fs_grupo == "Pouco Tolerante"), aes(reorder(genotipo, porcentagem), porcentagem, fill = porcentagem)) + 
  ...
  labs(x = "Genótipos",
                                          y = "Frequência Relativa (%)",
                                          title = "Intensidade percentual dos genotipos classificados como  Pouco  Tolerante na Doença FS") + theme(axis.line.y = element_blank())
